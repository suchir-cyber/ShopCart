...
const Register = () => {
  ...
  return (
    <section className="pl-[10rem] flex flex-wrap h-screen w-full bg-cover bg-center" >
        <div className="mr-[4rem] mt-[5rem]">
            ...
            <form onSubmit={submitHandler} className="container w-[40rem]">
                ...
                <div className="my-[2rem]">
                    ...
                    <input type="password" id="password" className="mt-1 p-2 border rounded w-full" placeholder="Enter paassword" value={password} onChange={e=>setPassword(e.target.value)}/>
                </div>
